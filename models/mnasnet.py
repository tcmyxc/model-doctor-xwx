...
class MnasNet(nn.Module):
    def __init__(self, in_channels=3, num_classes=10, input_size=224, width_mult=1.):
...
def mnasnet(in_channels=3, num_classes=10):
    return MnasNet(in_channels=in_channels, num_classes=num_classes)
