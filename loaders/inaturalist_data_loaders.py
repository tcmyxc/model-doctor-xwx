...
def load_images(data_type):
    ...
    data_dir  = config.data_inaturalist2018
    train_txt = config.data_inaturalist2018 + "/iNaturalist18_train.txt"
    test_txt  = config.data_inaturalist2018 + "/iNaturalist18_val.txt"
