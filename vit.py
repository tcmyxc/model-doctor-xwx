...
if __name__ == '__main__':
    ...
    # 如果训练自定义的数据集，图片大小不是224，要么resize，要么自己训
    model = vit_l_16(pretrained=False, image_size=32)
    # 修改最后一层，改成10分类的
    model_ftrs = model.heads[0].in_features
    model.heads = nn.Linear(model_ftrs, 10)
    model.to(device)
